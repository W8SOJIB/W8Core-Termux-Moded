...
NvChad is a modern Neovim configuration that provides a complete IDE-like experience out of the box. The W8Core-Termux-Moded version includes GitHub Copilot, CodeCompanion AI, preconfigured LSP support, syntax highlighting, file explorer, and much more.
